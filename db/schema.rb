...
ActiveRecord::Schema.define(version: 20151224010419) do
  ...
  add_index "friendrequests", ["requested_id"], name: "index_friendrequests_on_requested_id", using: :btree
  add_index "friendrequests", ["requester_id"], name: "index_friendrequests_on_requester_id", using: :btree
